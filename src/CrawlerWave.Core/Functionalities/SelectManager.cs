...
{
    private const string LoggerCategoryName = "CrawlerWave.SelectManager";

    public SelectManager(ILogger logger) : base(LoggerCategoryName, logger)
    {
    }

    public static SelectManager New(Crawler parent) => new SelectManager(parent.CreateLogger(LoggerCategoryName));
